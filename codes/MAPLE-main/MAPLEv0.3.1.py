...
parser.add_argument('--output',default="C:/Users/jan/Documents/!Bioinformatik/Softwarepraktikum/phylocovid/codes/MAPLE-main/files/MAPLE_output", help='output path and identifier to be used for newick output file.')
